...
Config.DoorList = {
	...
	-- Entrance Doors
	{
		...
		doors = {
			...
			{objHash = 0xF01594C6, objHeading = 270.0, objCoords = vector3(911.24,-976.95,38.5)}
		}
	},
	...
	{
		objHash = GetHashKey('v_ilev_vag_door'),
		objHeading = 94.0,
		objCoords = vector3(911.24,-976.14,39.95),
		textCoords = vector3(911.24,-976.14,39.95),
		authorizedJobs = {'STAFF'},
		locked = true,
		maxDistance = 0.4
	},
