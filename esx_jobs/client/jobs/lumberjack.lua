Config.Jobs.lumberjack = {
	...
	Zones = {
		...
		VehicleSpawner = {
			Pos = {x=1211.91,y=-1262.68, z = 34.17},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = false,
		...
		VehicleSpawnPoint = {
			Pos = {x=1206.69,y=-1262.65, z = 34.12},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Marker = -1,
			Blip = false,
			Name = _U("service_vh"),
		...
		VehicleDeletePoint = {
			Pos = {x=1211.91,y=-1256.19, z = 34.12},
			...
			Item = {
				{
					...
					requires_name = "Paquete de tablas",
					drop = 100
				}
			},
