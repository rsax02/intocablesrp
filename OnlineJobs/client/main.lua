...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, players, arcadius = 0, 0, 0, 0, 0, 0, 0, 0 -- Añadir aqui los trabajos
...
RegisterNetEvent('onlineJobs:ToggleUI')
AddEventHandler('onlineJobs:ToggleUI', function()
	ToggleScoreBoard()
 end)
