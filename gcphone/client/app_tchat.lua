...
RegisterNetEvent("gcPhone:tchat_thecrowsrp2channel")
AddEventHandler("gcPhone:tchat_thecrowsrp2channel", function(channel, messages)
...
RegisterNUICallback('tchat_getChannel', function(data, cb)
  TriggerServerEvent('gcPhone:tchat_thecrowsrp2channel', data.channel)
end)
