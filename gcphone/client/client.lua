...
--[[Citizen.CreateThread(function()
	while true do
		...
		if inventory and inventory['phone'] then
			DisplayRadar(inventory['phone'].count > 0)
		else
			DisplayRadar(false)
		end
	end
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  while takePhoto do
	...
	--exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/770137779975356468/rjlslT-yrP_3_PuWSAB0sOjuKXePu25fiJKAriSFR4-MAdxxvRHGZxFIQHovIINbaSEU", data.field, function(data)
      exports['screenshot-basic']:requestScreenshotUpload(data.url, data.field, function(dat)
        local resp = json.decode(dat)
        DestroyMobilePhone()
        CellCamActivate(false, false)
