...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {4.80, 7.95, 10.56, 15.62}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {0.68, 2.54, 4.20, 5.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {6.90, 8.02, 11.53}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.60, 2.44, 3.98, 5.87, 6.22}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {14.77, 17.28, 22.00, 33.00, 41.00, 45.00} --antes 69.77 --antes 190 180 antes
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
