...
playerPed, playerId, playerCoords = nil, nil, nil
IsDead, inVehicle = false, false
ESX = nil
...
--ESTO ES PARA QUE NO RECUPERE VIDA EL PERSONAJE AUTOMATICAMENTE, ANTES FALTABA EL WHILE TRUE, POR ESO NO FUNCIONABA
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(5)
...
function StartDistressSignal()
	Citizen.CreateThread(function()
		...
		while timer > 0 and IsDead do
			...
			EndTextCommandDisplayText(0.42, 0.430)
...
RegisterNetEvent('esx_ambulancejob:rethecrowsrp2vive')
AddEventHandler('esx_ambulancejob:rethecrowsrp2vive', function()
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
