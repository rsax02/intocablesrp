...
Config.JerryCanCost = 18
Config.RefillCost = 6 -- If it is missing half of it capacity, this amount will be divided in half, and so on.
...
Config.Strings = {
	ExitVehicle = "Sal del vehículo para cargar combustible",
	...
	CancelFuelingPump = "Presiona ~g~E ~w~para cancelar la carga de combustible",
	CancelFuelingJerryCan = "Presiona ~g~E ~w~para cancelar la carga",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el bidón por ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero para rellenar el bidón",
	JerryCanFull = "El bidón está lleno",
	TotalCost = "Precio",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para tomar el bidón"
